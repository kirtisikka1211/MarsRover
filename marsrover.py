...
class MainWindow(QMainWindow):
   ...
   def fetch_value(self):
    ...
    response = requests.get(f"https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?earth_date={selected_date}&api_key={KEY}&page=1&camera={selected_camera}")
    a = response.json()
    print(a)
    image_list = []
    for i in a['photos']:
    ...
    if not image_list:
        self.labelpic.setText("Oops, No images for this date\n    Try Again!.")
        self.show()
    folder_name = "IMAGE"
...
class AnotherWindow(QWidget):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.image.setPixmap(QPixmap("mars2222.jpg").scaled(400,400))
...
""")
  ...
  def sendEmail(self):
      ...
      if self.mm==1:
            ...
            QMessageBox.warning(self, "Error", "Inavalid Email Address Entered")
